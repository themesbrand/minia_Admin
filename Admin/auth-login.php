...
<head>
    ...
    <title>Login | AI Skin Recognizer</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Skin Recognizer</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="">
                                                    <a href="auth-recoverpw.php" class="text-muted">lupa password?</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Tidak memiliki akun ? <a href="auth-register.php" class="text-primary fw-semibold"> daftar sekarang</a> </p>
                                </div>
                            </div>
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                        document.write(new Date().getFullYear())
                                    </script> Tugas Akhir <i class="mdi mdi-heart text-danger"></i> Siti Romaenah</p>
                            </div>
                        </div>
                    </div>
                </div>
